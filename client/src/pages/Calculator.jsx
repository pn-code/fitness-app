...
const Calculator = () => {
  ...
  const handleSubmit = () => {
    if (gender == "male") {
      ...
      setCalories((10 * weight + 6.25 * height - 5 * age - 161) * activity);
    }
  };
      ...
      <form className="flex flex-col gap-4 rounded-md justify-center bg-gray-700 items-center py-8 mb-20 sm:w-[500px]">
        ...
        {showActivity && (
          <ul className="flex flex-col gap-2 mx-8 w-[180px] sm:text-sm sm:w-[250px]">
            <li>
              <span className="text-[#FDCA15]">Sedentary</span> - Little to no
              exercise, such as a desk job with no additional physical activity
            </li>
            <li>
              <span className="text-[#FDCA15]">Lightly Active</span> - Light
              exercise 1-2 days/week
            </li>
            <li>
              <span className="text-[#FDCA15]">Moderately Active</span> -
              Moderate exercise 3-5 days/week
            </li>
            <li>
              <span className="text-[#FDCA15]">Very Active</span> - Hard
              exercise 6-7 days/week
            </li>
            <li>
              <span className="text-[#FDCA15]">Extremely Active</span> - Hard
              daily exercise and physical job or two times a day training
            </li>
          </ul>
        )}
        ...
        <div className="calculator--output">
          {calories && (
            <div className="flex flex-col justify-center items-center my-4 gap-2">
              ...
              <p>
                Your daily calorie consumption required for maintenance is
                around{" "}
          ...
          <div className="bg-slate-700 rounded-lg p-5 mb-16 sm:bg-transparent">
            <div className="flex flex-col gap-8">
              ...
              <CaloriePlan
                ...
                calorieGoal={`${parseInt(calories) + 300} - ${parseInt(
                  calories + 500
                )}`}
              />
              <CaloriePlan
                ...
                calorieGoal={`${parseInt(calories - 1000)}-${parseInt(
                  calories - 500
                )}`}
              />
            </div>
