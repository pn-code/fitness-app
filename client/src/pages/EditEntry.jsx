...
const EditEntry = ({ user, API_URL }) => {
  ...
  const handleChange = (e) => {
    ...
    if (e.target.name === "plan") {
      ...
      setEntry((prevEntry) => ({
        ...prevEntry,
        exercises: plans.filter((plan) => plan._id !== entry.plan)[0].exercises,
      }));
    }
  };
    ...
    <div className="flex justify-center mb-5 text-white">
      <form className="flex flex-col justify-center items-center p-10 bg-gray-700 py-5 rounded-lg">
        <div className="flex items-center mb-4 gap-8">
          ...
          <h4 className="text-xl font-semibold mt-4">Edit Journal Entry</h4>
        </div>
            ...
            <div>
              <h4 className="text-[18px] flex gap-4">
                ...
                <button
                  ...
                  onClick={() =>
                    setViewAllExercises((viewAllExercises) => !viewAllExercises)
                  }
                  type="button"
                >
                  {viewAllExercises ? (
                    ...
                    <div className="mt-2" key={exercise.id}>
                      ...
                      <div className="flex gap-8">
                        <div className="flex flex-col">
                          ...
                          <input
                            onChange={(e) =>
                              handleExerciseChanges(e, exercise.id)
                            }
