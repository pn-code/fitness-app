						...
						{exercises.map((exercise) => (
							<li>
								<div className="flex justify-between w-96">
									<h5>{exercise.name}</h5>
                  <button onClick={() => deleteExercise(exercise.id)} type="button" className="px-3 py-1 bg-red-600 text-white text-sm rounded-full hover:bg-red-400">Delete Exercise</button>
								</div>
